...
/**
 * Обновляет страницу после истечения времени бездействия.
 */
function reloadPage() {
...
/**
 * Сбрасывает таймеры и устанавливает новое время начала отсчета.
 */
function resetInactivityTimer() {
    ...
    intervalTimer = setInterval(logRemainingTime, 30*1000); // Обновляем лог каждые 30 секунд
}

/**
 * Вычисляет и логирует оставшееся время до обновления страницы.
 */
...
document.addEventListener('keydown', resetInactivityTimer); // При нажатии клавиш
