...
class CitiesActionLoggingMiddleware:
    ...
    def __call__(self, request) -> HttpResponse:
        ...
        file_names = (
            [f.name for f in request.FILES.getlist("cityFile")] if request.FILES else []
        )
        body_data = None
        ...
        if (
            ...
            path.startswith("/cities/admin/city-info/")
            and user.is_authenticated
