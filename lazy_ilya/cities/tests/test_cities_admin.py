...
class CitiesAdminTests(TestCase):
    ...
    def setUp(self):
        ...
        self.user = CustomUser.objects.create_user(username='user', password='pass', phone_number='+79852000338')

        # Пользователь с группой admin
        self.admin_user = CustomUser.objects.create_user(username='adminuser', password='pass',phone_number='+79852000355')
