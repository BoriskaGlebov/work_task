...
class CityInfoViewTests(TestCase):
    def setUp(self):
        ...
        self.admin_user = CustomUser.objects.create_user(username='adminuser', password='pass',
                                                         phone_number='+79852000338')
        self.admin_user.groups.add(self.admin_group)
        self.admin_user.save()

        self.regular_user = CustomUser.objects.create_user(username='regularuser', password='pass',
                                                     phone_number='+79852000558')
