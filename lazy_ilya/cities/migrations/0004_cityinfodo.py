        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "cipa",
                    models.CharField(
                        blank=True, max_length=255, null=True, verbose_name="Номер CIPA"
                    ),
                ),
                (
                    "recipient",
                ...
                (
                    "ip_phone",
                    models.CharField(
                        blank=True, max_length=255, null=True, verbose_name="IP телефон"
                    ),
                ),
                (
                    "notes",
                    models.CharField(
                        blank=True, max_length=255, null=True, verbose_name="Заметки"
                    ),
                ),
                (
                    "globus",
