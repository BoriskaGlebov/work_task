...
set STICKERS_STATIC=..\stickers\static\stickers
...
if exist "%STICKERS_STATIC%" (
    rmdir /S /Q "%STICKERS_STATIC%"
)
mkdir "%STICKERS_STATIC%"
...
robocopy "%BUILD_DIR%\stickers" "%STICKERS_STATIC%" /E
