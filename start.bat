...
REM Проверяем и создаем суперпользователя, если он не существует
echo Checking and creating superuser if necessary...
python create_superuser.py
REM Запускаем скрипт "create_superuser.py", который проверяет, существует ли суперпользователь в базе данных, и создает его, если он не существует.
